...
export function ModalCantorView({
  isOpen,
  onClose,
          ...
          <div className="flex flex-col gap-6">
            <div className="space-y-2">
              <div className="border-b border-white/20 pb-4 mb-4 flex items-start gap-4">
                <img
                  src={apresentacaoSelecionada?.imagem}
                  alt=""
              ...
              <div className="space-y-6">
                <div className="flex flex-col font-light">
                  <span className="text-amarelo-bb">Categoria</span>
                  <span className="text-xl text-white">
                    {apresentacaoSelecionada?.genero}
                  </span>
                </div>
                <div className="flex flex-col font-light">
                  <span className="text-amarelo-bb">Nome da música</span>
                  <span className="text-xl text-white">
                    {apresentacaoSelecionada?.nome}
                  </span>
                </div>
