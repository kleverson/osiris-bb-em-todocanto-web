...
export function Section1() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full px-4 grid grid-cols-1 lg:grid-cols-2 items-center py-8 pb-24 gap-8 relative">
        <div className="flex flex-col justify-center">
          ...
          <p className="text-sm lg:text-base text-azul-600 mt-10 font-light hidden sm:block">
            *Confira o regulamento da campanha.
          </p>
        </div>
      </div>
      <div className="max-w-7xl mx-auto text-center space-y-3 pt-48 md:pt-0">
